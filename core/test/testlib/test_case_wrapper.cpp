...
#include "../../l15/src/core/mnemonic.hpp"

namespace utxord {

const std::array<const char*, 2048> TestcaseWrapper::en_dict = {
...
const l15::core::MnemonicParser<const std::array<const char*, 2048>&> TestcaseWrapper::mnemonic_parser(TestcaseWrapper::en_dict);
