...
TEST_CASE("Swap")
{
    ...
    CHECK_NOTHROW(builderMarket.MarketFee(MARKET_FEE, bech->Encode(swap_script_key_M.GetLocalPubKey())));
...
TEST_CASE("FundsNotEnough")
{
    ...
    SwapInscriptionBuilder builderMarket(*bech);
    builderMarket.MarketFee(MARKET_FEE, bech->Encode(swap_script_key_M.GetLocalPubKey()));
    builderMarket.SetOrdMiningFeeRate(FormatAmount(ParseAmount(fee_rate) * 2));
    builderMarket.SetSwapScriptPubKeyM(hex(swap_script_key_M.GetLocalPubKey()));
...
TEST_CASE("SwapV4Compatibility")
{
    ...
    ChannelKeys swap_script_key_A(unhex<seckey>("cd4d33483ea6df5e02ffd9be033ad9658ad29256e0f2b999411c9acd7fd055e2"));
    ChannelKeys swap_script_key_B(unhex<seckey>("f0c30eb14ffbaa779bf78082681d03e9ca5b630ea5718ceeb2453c5743ff2ca6"));
    ChannelKeys swap_script_key_M(unhex<seckey>("35156d1ed6df8e9017c2d42dd82cf6921aaa5da7af2191046dbe16a86d76610c"));
    ChannelKeys ord_utxo_key(unhex<seckey>("6e934f1970c20f7abc34b991dc93bcfaf6cf5e633d3e2848daecf51d1ddd9aef"));
    ChannelKeys funds_utxo_key(unhex<seckey>("2d16356be916c800cdb80f5502de9893ef56f4bed6f763a2dd7bb9159751e4cb"));
