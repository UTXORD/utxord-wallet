...
BUILD_DIR="/utxord-wallet/core/build/src/python_binding"
...
docker cp $CONTAINER_NAME:$BUILD_DIR/libutxord_pybind.py $HOST_DIR/libutxord_pybind.py
docker cp $CONTAINER_NAME:$BUILD_DIR/_libutxord_pybind.so $HOST_DIR/_libutxord_pybind.so
